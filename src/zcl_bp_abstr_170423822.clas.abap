CLASS zcl_bp_abstr_170423822 DEFINITION ABSTRACT PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS: constructor
      ...
      display.
    "NOTE: get_reloe has NO code here - it is abstract
    "NOTE: display_spesific_data has NO code here - it is abstract!
...
CLASS zcl_bp_abstr_170423822 IMPLEMENTATION.
