CLASS zcl_bp_oo_demo_170423822 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_bp_oo_demo_170423822 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA(lo_bp) = NEW zcl_bp_super_170423822(
    iv_bp_number = '00001'
    ...
    DATA(lo_cust_child) = NEW zcl_cust_child_170423822(
    iv_bp_number = '00002'
    ...
    DATA(lo_vend_child) = NEW zcl_vend_child_170423822(
    iv_bp_number = '00003'
    ...
    DATA: lo_bp_poly TYPE REF TO zcl_bp_super_170423822.
    ...
    DATA(lo_domestic) = NEW zcl_cust_cl1fr_if_170423822(
...
* lo_domestic->zif_cust_intf_ecemyalim~display( ).
    ...
    DATA(lo_international) = NEW zcl_cust_cl2fr_if_170423822(
...
* lo_international->zif_cust_intf_ecemyalim~display( ).
    ...
    DATA: lo_if_cust TYPE REF TO zif_cust_intf_170423822.
    ...
    DATA(lo_cust_abstr) = NEW zcl_cust_fr_abstr_170423822(
    iv_bp_number = '00005'
    ...
    DATA(lo_vend_abstr) = NEW zcl_vend_fr_abstr_170423822(
    iv_bp_number = '00006'
    ...
    DATA: lo_abstr_poly TYPE REF TO zcl_bp_abstr_170423822.
    ...
    DATA: lt_partners TYPE TABLE OF REF TO zcl_bp_abstr_170423822.
