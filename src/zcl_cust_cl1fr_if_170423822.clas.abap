CLASS zcl_cust_cl1fr_if_170423822 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES zif_cust_intf_170423822 .
...
CLASS zcl_cust_cl1fr_if_170423822 IMPLEMENTATION.
  ...
  METHOD zif_cust_intf_170423822~calculate_tax.
    "Domestic Türkiye: 18% KDV
    rv_tax = iv_amount * 18 / 100.
  ENDMETHOD.


  METHOD zif_cust_intf_170423822~check_credit.
  ...
  METHOD zif_cust_intf_170423822~get_credit_limit.
    rv_limit = mv_credit_limit.
  ENDMETHOD.


  METHOD zif_cust_intf_170423822~get_customer_no.
    rv_cust = mv_customer_no.
  ENDMETHOD.


  METHOD zif_cust_intf_170423822~get_name.
    rv_name = mv_name.
  ENDMETHOD.
ENDCLASS.
