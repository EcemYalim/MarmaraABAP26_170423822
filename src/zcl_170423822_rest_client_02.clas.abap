CLASS zcl_170423822_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423822_rest_client_02 IMPLEMENTATION.
...
*  io_out->write( user_delete( ) ).
  ...
  METHOD user_get.
    ...
    rv_text = execute_request(
      iv_method = 'GET'
      iv_url    = gc_base_url && '/user/demo_ipek' ).
